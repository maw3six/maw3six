...
td {
   ...
   font-size:11px; font-family:Tahoma,Verdana,Arial; color:#3bb507; 
}
.me  {
   font-size:11px; font-family:Tahoma,Verdana,Arial; color:#3bb507; 
   border: 0px;
...
<body>
<center><br><font color="#3bb507" size="14" face="arial">Find Me</font></center><br>
<?php
